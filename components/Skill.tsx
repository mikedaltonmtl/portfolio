...
export default function Skill({ directionLeft, url, name }: Props) {
  return (
    <div className="group relative flex cursor-pointer">
      <motion.img
        ...
        src={ url }
        className="rounded-full border border-gray-500 object-cover w-16 h-16 md:w-24 md:h-24 filter group-hover:grayscale transition duration-500 ease-in-out"
      />
