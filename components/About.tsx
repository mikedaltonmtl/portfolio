  ...
  return (
    ...
    >
      ...
      <motion.img
        ...
        className="mt-24 md:mb-0 md:mt-0 flex-shrink-0 w-56 h-56 rounded-full object-cover md:rounded-lg md:w-64 md:h-96 xl:w-[333px] xl:h-[400px] border border-white"
        // viewport={{ once: true }}
      />
      <div className="space-y-10 px-0 md:px-10 x:500">
